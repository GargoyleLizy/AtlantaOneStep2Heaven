...
! function(e) {
                        ...
                        if (c) {
                            ...
                            switch (d.type) {
                                ...
                                case s.CHART_TYPE_SCATTER:
                                    for (var m = e.dataIndex, a = 0, o = y.length; o > a; a++)
                                        if (null == y[a]._mark && l.get(y[a], "seriesIndex") == t && l.get(y[a], "dataIndex") == m) {
                                ...
                                case s.CHART_TYPE_RADAR:
                                    for (var m = e.dataIndex, a = 0, o = y.length; o > a; a++)
                                        if ("polygon" === y[a].type && l.get(y[a], "seriesIndex") == t && l.get(y[a], "dataIndex") == m) {
                                            this._curTarget = y[a];
                                ...
                                case s.CHART_TYPE_PIE:
                                    for (var b = e.name, a = 0, o = y.length; o > a; a++)
                                        if ("sector" === y[a].type && l.get(y[a], "seriesIndex") == t && l.get(y[a], "name") == b) {
                                            this._curTarget = y[a];
                                ...
                                case s.CHART_TYPE_MAP:
                                    for (var b = e.name, k = r.mapType, a = 0, o = y.length; o > a; a++)
                                        if ("text" === y[a].type && y[a]._mapType === k && y[a].style._name === b) {
                                ...
                                case s.CHART_TYPE_CHORD:
                                    for (var b = e.name, a = 0, o = y.length; o > a; a++)
                                        if ("sector" === y[a].type && l.get(y[a], "name") == b) {
                                            this._curTarget = y[a];
                                            var _ = this._curTarget.style,
                                                x = (_.startAngle + _.endAngle) / 2 * Math.PI / 180;
                                ...
                                case s.CHART_TYPE_FORCE:
                                    for (var b = e.name, a = 0, o = y.length; o > a; a++)
                                        if ("circle" === y[a].type && l.get(y[a], "name") == b) {
    ...
    return t.prototype = {
        ...
        ondragend: function(e, t) {
            this.isDragend && e.target && (!this.timelineOption.realtime && this._setCurrentOption(),
                t.dragOut = !0, t.dragIn = !0, t.needRefresh = !1, this.isDragend = !1, this._syncHandleShape())
        },
        last: function() {
                    ...
                    if (U) {
                        ...
                        if (U) {
                            ...
                            var z = function(e, o) {
                                    ...
                                    if (0 !== d) {
                                        if (w = (o - x[v]) / d, m)
                                            if (I = k[v], X = k[0 === v ? v : v - 1], K = k[v > U - 2 ? U - 1 : v + 1], S = k[v > U - 3 ? U - 1 : v + 2], f) r(X, I, K, S, w, w * w, w * w * w, l(e, V), b);
                                            else {
                                                var c;
    ...
    return t.prototype = {
        ...
        brush: function(e, t) {
            var i = this.style;
            t && (i = this.getHighlightStyle(i, this.highlightStyle || {})), e.save(), this.setContext(e, i), this.setTransform(e), e.save(), e.beginPath(), this.buildPath(e, i),
                e.stroke(), e.restore(), this.brushSymbol(e, i, 0), this.brushSymbol(e, i, 1), this.drawText(e, i, this.style), e.restore()
        },
        buildPath: function(e, t) {
    ...
    return t.prototype = {
        ...
        _buildBackground: function() {
            ...
            "horizontal" == this.zoomOption.orient ? (f.push([this._location.x + e, this._location.y + t]),
                f.push([this._location.x, this._location.y + t])) : (f.push([this._location.x, this._location.y]), f.push([this._location.x, this._location.y + t])), this.shapeList.push(new a({
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {
                    pointList: f,
